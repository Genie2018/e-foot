			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Modifier un terrain</h2>
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{url('/modifier-terrain',$terrain_info->terrain_id)}}" method="post">
							{{ csrf_field() }}
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="terrain_nom" value="{{$terrain_info->terrain_nom}}" required="">
							  </div>
							</div>

							<div class="control-group">
								<label class="control-label" for="selectError3">terrain Categorie</label>
								<div class="controls">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="terrain_prix" value="{{$terrain_info->terrain_prix}}" required="">
							  </div>
							</div>
