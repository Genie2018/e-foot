...
@section('content')
@include('slider')
                        <h2 class="title text-center">Produits Disponibles</h2>
                       <?php foreach($tous_produit_publication as $v_produit_publication){?> 
                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{URL::to($v_produit_publication->produit_image)}}" style="height: 200px;" alt="" />
