...
@section('content')
                       ...
                       <?php foreach($produit_par_categorie as $vproduit_par_categorie){?> 
                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{URL::to($vproduit_par_categorie->produit_image)}}" style="height: 200px;" alt="" />
                                            <h2>{{$vproduit_par_categorie->produit_prix}} Franc CFA</h2>
                                            <p>{{$vproduit_par_categorie->produit_nom}}</p>
